...
def get_tfidf(sum,result,tfidf):
...
for filename in os.listdir(filedir):
    ...
    #sum有3093835条微博
    NNinput(sum,result,filename,tfidf)
    sum=sum+result[0]
    #print("sum:"+str(sum))
